...
public class ProfileServiceTest extends TestEnvironment {
    ...
    public void test_add_withValidElementaryProfileEntity() throws ServiceException {
        ...
        TestCase.assertTrue(profileA.getName().equals("Profile A"));
        ...
        TestCase.assertTrue(profileA.getWatermark().isEmpty());
        TestCase.assertTrue(profileA.getPairCameraPositions().isEmpty());
        TestCase.assertTrue(profileA.getPairLogoRelativeRectangles().isEmpty());
    }
        ...
        TestCase.assertTrue(profileB.getName().equals("Profile B"));
        TestCase.assertTrue(profileB.isPrintEnabled());
        TestCase.assertTrue(profileB.isFilerEnabled());
        TestCase.assertTrue(profileB.isGreenscreenEnabled());
        TestCase.assertTrue(profileB.isMobilEnabled());
        TestCase.assertTrue(profileB.getWatermark().equals("/dev/null/watermarkB.jpg"));
        ...
        TestCase.assertTrue(profileB.getBackgroundCategories().contains(backgroundCategory1));
        TestCase.assertTrue(profileB.getBackgroundCategories().contains(backgroundCategory2));
        TestCase.assertTrue(profileB.getBackgroundCategories().contains(backgroundCategory3));
        TestCase.assertTrue(profileB.getBackgroundCategories().contains(backgroundCategory4));
    }
    ...
    */
    ...
    public void test_get_withValidInt() throws ServiceException{
        ...
        TestCase.assertTrue(profile1.getName().equals("Profile 1"));
        ...
        TestCase.assertTrue(profile1.getWatermark().isEmpty());
        ...
        TestCase.assertTrue(profile2.getName().equals("Profile 2"));
        ...
        TestCase.assertTrue(profile2.getWatermark().isEmpty());
    ...
    public void editProfileWithValidArgument() throws ServiceException {
        ...
        TestCase.assertTrue(profileB.getWatermark().equals("/dev/null/watermarkBBB.jpg"));
        assertTrue(!profileB.getPairCameraPositions().isEmpty());
        assertTrue(profileB.getPairCameraPositions().size() == 2);
        assertTrue(profileB.getPairCameraPositions().get(0).getCamera().getId()==1);
        assertTrue(profileB.getPairCameraPositions().get(0).getPosition().getId()==1);
