...
public interface CameraDAO {
    ...
    /**
     * Persists a given camera
     * object
     * @param camera - camera
     *              object to be persisted, must not be null
     * @return persisted camera
     * object with autoassigned id
     ...
     * @param cameraID - camera
     *                to be removed is identified by its id
     * @throws PersistenceException if persistence data store can not be accessed
     */
     ...
     *          that is looked for
     * @return camera
     * that has been looked for, if a camera
     * with given id doesn't
    ...
    /**
     * Sets the camera
     * with the given ID to inactive
     * @param cameraID - ID of the camera
     *                that will be set inactive
     * @throws PersistenceException if persistence data store can not be accessed
     */
    ...
    /**
     * Looks a given camera
     * up and returns if it already exists
     * @param camera - camera, which will be looked up in the persistence
     * @return the stored camera if it is already saved (identified camera model)
     * @throws PersistenceException if the data store cannot be accessed or an error during access occurs
     */
    Camera getCameraIfExists(Camera camera) throws PersistenceException;

    /**
     * Updates the given camera in the persistence
     * @param camera - camera which will be edited in the persistence
     * @throws PersistenceException if the data store cannot be accessed or the no camera with the given id exists
     */
    void editCamera(Camera camera) throws PersistenceException;
}
